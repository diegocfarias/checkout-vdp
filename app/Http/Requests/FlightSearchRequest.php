...
class FlightSearchRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'inbound_date' => 'required_if:trip_type,roundtrip|nullable|date|after_or_equal:outbound_date',
    ...
    public function messages(): array
    {
        return [
            ...
            'infants.lte' => 'O número de bebês não pode exceder o de adultos.',
