...
Se o site estiver em outro diretorio, defina `APP_DIR` antes:

```bash
APP_DIR=/home/forge/checkout-dev.voedeprimeira.com bash deploy/development.sh
```
...
Se o diretorio de producao for diferente do padrao, use:

```bash
APP_DIR=/home/forge/voedeprimeira.com bash deploy/production.sh
```
